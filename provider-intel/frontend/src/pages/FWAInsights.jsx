export default function FWAInsights({ session }) {
  return (
    <div>
      <h1 className="text-2xl font-extrabold text-lh-dark mb-1">FWA Insights</h1>
      ...
      <div className="bg-white rounded-2xl p-8 shadow-sm text-center text-gray-400">
        ...
        <p className="font-semibold text-lh-dark">FWA Insights</p>
